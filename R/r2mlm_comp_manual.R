...
#'   variables.
#' @param between_covs_modA,between_covs_modB List of numbers corresponding to the columns in the
#'   dataset of the level-1 predictors used in the MLM (if none used, set to
#'   NULL).
#' @param random_covs_modA,random_covs_modB List of numbers corresponding to the columns in the
#'   dataset of the level-1 predictors that have random slopes in the MLM (if no
#'   random slopes, set to NULL).
#' @param gamma_w_modA,gamma_w_modB Vector of fixed slope estimates for all level-1 predictors, to
#'   be entered in the order of the predictors listed by within_covs (if none,
#'   set to NULL).
#' @param gamma_b_modA,gamma_b_modB Vector of fixed intercept estimate (if applicable; see
...
#' @param Tau_modA,Tau_modB Random effect covariance matrix; note that the first row/column
